...
def load_configs_initialize_training():
    ...
    #parser.add_argument("-cfg", "--cfg_file", type=str, default="configs/CIFAR10/SNGAN.yaml")
    ...
    return cfgs, gpus_per_node, hdf5_path, rank


def mainer():
    cfgs, gpus_per_node, hdf5_path, rank = load_configs_initialize_training()
    ...
    #        misc.cleanup()
    #else:
    uses = load_gan.load_gan(local_rank=rank,
                           cfgs=cfgs)
